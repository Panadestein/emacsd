...
I also heavily use the =emacs-jupyter= package to communicate with Jupyter kernels. Due to complications managing Python
environments in NixOS, I added directly on my =configuration.nix= file:
