...
#+begin_src emacs-lisp
  (use-package bqn-mode
    ...
    (defun quail-completion--disable-for-bqn (orig-fun &rest args)
      (unless (string= "BQN-Z" current-input-method)
        (apply orig-fun args)))
    (advice-add 'quail-completion :around #'quail-completion--disable-for-bqn)
