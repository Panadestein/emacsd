...
On my experience however, =eglot= has better support for editing with TRAMP:
...
#+begin_src emacs-lisp
  (use-package org-tempo
    ...
    (setq org-todo-keywords
          '((sequence "TODO(t)" "BROKEN(b)" "RUNNING(f)" "VERIFY(v)" "URGENT(u)"
                      "|" "DONE(d)" "OPTIONAL(o)" "DELEGATED(d)" "IRRELEVANT(i)")))
    (setq org-todo-keyword-faces
	        '(("BROKEN" . "red") ("RUNNING" . "yellow")
	          ("VERIFY" . "goldenrod") ("URGENT" . "orange")
