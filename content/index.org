...
ditching =package.el=, I decided to go for the option that ensures reproductibility: [[https://github.com/radian-software/straight.el][straight.el]]. With this
...
For reference, I still show here how to set =use-package= with =package.el=. First we add the the GNU ELPA
and MELPA archives, and then ensure use-package:
